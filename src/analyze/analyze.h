...
class Analyze {
 ...
 private:
  ...
  void check_clause(const std::vector<std::string> &tables, std::vector<Condition> &conds);
  ...
  //   void check_having_clause(const std::vector<ColMeta> &all_cols, std::vector<Condition> &conds,
  //                            const std::vector<TabCol> &group_by_cols);
  void check_having_clause(const std::vector<std::string> &tables, std::vector<Condition> &conds,
                           const std::vector<TabCol> &group_by_cols);
};
